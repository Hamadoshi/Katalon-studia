...
WebUI.setText(findTestObject('Object Repository/Register_Page/inp_lastname'), surname)
...
WebUI.click(findTestObject('Object Repository/Register_Page/btn_submit'))
